...
type: issue
state: closed
created: 2026-06-10T07:23:56Z
updated: 2026-06-10T08:42:32Z
author: github-actions[bot]
author_url: https://github.com/github-actions[bot]
url: https://github.com/vig-os/devcontainer/issues/578
comments: 1
labels: bug, area:ci
assignees: none
milestone: none
...
parent: none
children: none
synced: 2026-06-10T10:26:40.193Z
---

# [Issue 578]: [Release 0.3.5-rc1 failed -- automatic rollback](https://github.com/vig-os/devcontainer/issues/578)
...
**Workflow Run:** [View logs](https://github.com/vig-os/devcontainer/actions/runs/27260137636)
...
_Posted on June 10, 2026 at 08:42 AM_

Fixed in #579 (merged into release/0.3.5). Root cause: the base-image pin was set to the amd64-only child manifest digest instead of the multi-arch index digest, so the arm64 build leg failed with `exec /bin/sh: exec format error`. Restored the index digest `sha256:a9bee155…`. Ready to publish 0.3.5-rc2 to validate.
